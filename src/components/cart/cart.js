              ...
              props.children ?
                <TableRow>
                  ...
                  <TableCell align="center">
                    ...
                    <Button variant="contained" style={styleButton} onClick={() => {  checkoutProductButton(props.cart) }}> MUA HÀNG</Button>
                  </TableCell>
...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    checkoutProduct: (cart) => {
      dispatch(actions.productCheckout(cart))
