  ...
  return (
    <div>
      ...
      <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} aria-label="breadcrumb">
        <Link  style={{fontSize:"15px" , color:"#05a"}} color="inherit" to="/" >
          Shopsale
        </Link>
        <Link  style={{fontSize:"15px" , color:"rgba(0, 0, 0, 0.87)" }} color="inherit"  to={{ pathname: "/" +  pro.categories }}>
         {pro.categories ? pro.categories : ""}
        </Link>
        <Typography style={{fontSize:"15px" }} color="textPrimary">{pro.title}</Typography>
      </Breadcrumbs>
    </div>
        <div
          style={{
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={10} md={6} lg={6}>
                ...
                <h3>
                  ...
                  {showRating(pro.star)}
                  <span style={{color:"gray", fontSize:"18px"}}> | Đã bán :{pro.quantity}</span>
                </h3>
