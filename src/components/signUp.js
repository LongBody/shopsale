...
import {signUpApi} from '../utils//callApi'
        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              ...
              />
               {
              checkPassword ? <Alert severity="error" >Missing Password!</Alert>
              : ""
               }
            </Grid>
            <Grid item xs={12}>
              ...
              />
               {
              checkConfirmPassword ? <Alert severity="error" >Missing ConFirm Password!</Alert>
              : ""
               }
            </Grid>
            <Grid item xs={12}>
            ...
            {
              checkPasswordAndConfirmPassword ? <Alert severity="error" >Password Not Match!</Alert>
              : ""
               }
               {
          ...
          <Grid container justify="flex-end">
            <Grid item>
              <Link href="/shopsale/#/shopsale/sign-in" variant="body2">
