...
function Product(props) {
    ...
    return (
        ...
        <InputLabel htmlFor = "age-native-simple" > Giá </InputLabel> <Select native value = { state.price } // cai nay la state object
        ...
        <option value = { "asc" } > Thấp Đến Cao </option> <option value = { "desc" } > Cao Đến Thấp </option> </Select> </FormControl>
        ...
        {
            result.length > 0 ? result : <div style = {
                { textAlign: "center", color: "#e79413" }
            }> <h2> { loading } </h2></div>
        } </Grid>
